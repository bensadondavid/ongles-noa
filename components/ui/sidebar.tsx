...
export function SignOutButton() {
  ...
  <SidebarMenuButton
    ...
    className="h-11 gap-3 rounded-full px-4 font-primary text-[15px] tracking-wide text-foreground/70 transition-colors hover:bg-destructive/10 hover:text-destructive"
  >
...
export function SignInButton() {
  ...
  <SidebarMenuButton
    ...
    className="h-11 gap-3 rounded-full px-4 font-primary text-[15px] tracking-wide text-foreground/70 transition-colors hover:bg-destructive/10 hover:text-destructive"
  >
    <LogIn className="size-4.5 opacity-70" />
    <span>Sign In</span>
  </SidebarMenuButton>
);
}
